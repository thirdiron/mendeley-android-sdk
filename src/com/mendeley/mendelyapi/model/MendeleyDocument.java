...
public class MendeleyDocument {
	...
	public MendeleyDocument(String id, String title, ArrayList<Person> authors, int year) {
		this.id = id;
		this.title = title;
	...
	public String getAuthorsString() {
		...
		for (int i = 0; i < authors.size(); i++) {
			...
			authorsString += authors.get(i).surname + " " + authors.get(i).forename.substring(0, 1);
		}
